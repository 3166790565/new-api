...
import { REGISTRATION_CODE_STATUS, SUCCESS_MESSAGES } from '../constants'
import { isRegistrationCodeExpired, isCodeExhausted } from '../lib'
...
export function DataTableRowActions<TData>({
  ...
  const isExpired = isRegistrationCodeExpired(code.expired_time, code.status)
  const isExhausted = isCodeExhausted(code.used_count, code.max_uses)
