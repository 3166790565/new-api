...
export const STATIC_I18N_KEYS = [
  ...
  'Failed to delete invalid registration codes',
  'Failed to update registration code status',
  'Name must be between {{min}} and {{max}} characters',
  'Length must be between {{min}} and {{max}}',
  'Count must be between {{min}} and {{max}}',
  'Expired time cannot be earlier than current time',
  'Successfully created {{count}} registration codes',
  'Created {{created}} registration codes',
  ...
  'Manual code entry (one per line)',
  'Manual codes',
  'One registration code per line',
  'Duplicates and existing codes are skipped',
  'Enter at least one code to add manually, or a charset/length/count to generate',
  'Max uses must not be negative',
  'Optional prefix',
  'Optional suffix',
  '0 means unlimited',
  'Between 4 and 32 characters',
  'Create multiple registration codes at once (1-500)',
  'Name for this registration code (1-64 characters)',
  'Full Registration Code',
  'Copy registration code',
  'Successfully deleted {{count}} invalid registration codes',
  'This will delete all',
  'Delete Invalid Registration Codes?',
  'used up',
  'Filter by name or code...',
  '{{used}} / {{max}} uses',
  'Registration codes created',
